execute if score @s elytra_gifts matches 1.. run tellraw @a {"selector":"@s", "extra": [{"text":" you've been gifted ", "extra": [{"score":{"name":"@s","objective":"elytra_gifts"}, "extra": [" elytra already. Do not be greedy."] }]}],"color":"red"}
